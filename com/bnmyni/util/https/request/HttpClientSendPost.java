...
import com.pica.common.util.HttpUtil;
...
public class HttpClientSendPost {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		...
		String  xmlData = "";
		String reponse = HttpClientSendPost.sendXMLDataByPost(url, xmlData);
	...
	//	post.setRequestBody(param);
		...
		post.setHeader("Content-Type", "tapplication/x-www-form-urlencoded;charset=utf-8");
