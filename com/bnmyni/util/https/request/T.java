...
import com.pica.worldcup.util.HttpClientUtils.miTM;
...
public class T { 
    public static void main(String[] args)throws Exception{ 
        ...
        String url = "https://auth.cytxl.com.cn/atrifact/login.json";
        String url_ok = "https://www.cebbank.com/per/QueryMerchantEpay.do";
//    	params.put("appid", "IQSR"); 
//    	params.put("pass_id", "IQSR"); 
//    	params.put("sso_uid", "IQSR"); 
//    	params.put("gateway", "IQSR"); 
//    	params.put("credential", "IQSR"); 
//    	params.put("type", "IQSR"); 
//    	params.put("clientType", "IQSR"); 
//    	params.put("once", "IQSR"); 
        sendSSLPostRequest(url_ok, params); 
    } 
